...
<p align="center">A responsive solution to the Huddle Landing Page With A Single Introductory Section challenge on Frontend Mentor.</p>


<h3 align="center">
  🌐 <a href="https://codecove01-netizen.github.io/Huddle-Landing-Page-With-A-Single-Introductory-Section/">Live Demo</a>
  &nbsp;|&nbsp;
  📂 <a href="https://github.com/codecove01-netizen/Huddle-Landing-Page-With-A-Single-Introductory-Section">Source Code</a>
  &nbsp;|&nbsp;
  🎯 <a href="https://www.frontendmentor.io/challenges/huddle-landing-page-with-a-single-introductory-section-B_2Wvxgi0">Challenge</a>
</h3>
...
<p align="center">
  <img src="./huddleDesktop.png" alt="Desktop Preview" width="900">
</p>
...
<p align="center">
  <img src="./huddleMobile.png" alt="Mobile Preview" width="250">
</p>
...
- Built a responsive landing page using a mobile-first approach.
- Used CSS Grid to create the desktop two-column layout.
- Practiced combining Grid and Flexbox for different layout requirements.
- Improved my understanding of `grid-template-areas` for page structure.
- Used `clamp()` to create fluid sizing for the logo and typography.
- Added accessible focus states and ARIA labels for interactive elements.
- Gained more confidence in creating responsive layouts that adapt smoothly across different screen sizes.
---

## 🎯 The Challenge

- Build out this Huddle Landing Page With A Single Introductory Section and get it looking as close to the design as possible.
